...
vim.api.nvim_create_user_command("TabnineAccept", function()
	M.accept_new_code()
end, {})

vim.api.nvim_create_user_command("TabnineReject", function()
	M.reject_new_code()
end, {})
