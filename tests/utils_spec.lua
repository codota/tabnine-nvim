...
describe("utils", function()
	...
	describe("remove_matching_prefix", function()
		it("works", function()
			eq(".txt", utils.remove_matching_prefix("hello.txt", "hello"))
			eq("hello.txt", utils.remove_matching_prefix("hello.txt", ""))
			eq("", utils.remove_matching_prefix("hello.txt", "hello.txt"))
			eq("t", utils.remove_matching_prefix("hello.txt", "hello.tx"))
		end)
		it("doesn't remove things it shouldn't", function()
